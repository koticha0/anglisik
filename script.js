...
async function loadExercises() {
    exercisesContainer.innerHTML = '<p style="text-align:center; padding: 20px;">Загрузка заданий...</p>';
    ...
    try {
        ...
        exercisesContainer.innerHTML = `
            <div style="text-align: center; color: #ef4444; padding: 20px;">
                ...
                <p>Не удалось загрузить файл с ответами. Если вы открыли файл локально, браузер может блокировать запросы.</p>
            </div>
        `;
    }
}
